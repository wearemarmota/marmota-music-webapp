...
const Header = (props) => {
  ...
  const replaceQueueAndPlay = () => {
    const songs = albums.reduce((accumulator, album) => {
      ...
      <div className="container">
        ...
        <div className="data">
          ...
          <div className="actions">
            <Button primary minWidth onClick={replaceQueueAndPlay}>
              Reproducir {songsCount} temas
            </Button>
            <Dropdown>
              <Dropdown.Handler>
                <Button>
              ...
              <Dropdown.List>
                <Dropdown.Item hideOnClick>
                  <Link to={`/artist/${artist.id}/edit`}>Editar artista</Link>
                </Dropdown.Item>
                <Dropdown.Divider />
